...
import { PasswordTemplate } from 'src/templates';
...
export function PasswordRecoveryPage(props: LoginPageProps) {
  ...
  return <PasswordTemplate onSubmitLogin={onSubmitLogin} title="" />;
}

export default PasswordRecoveryPage;

PasswordRecoveryPage.LayoutProps = {
  darkBg: false,
