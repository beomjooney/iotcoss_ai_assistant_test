...
import { CompanyLoginTemplate } from 'src/templates';
...
export function CompanyLoginPage(props: CompanyLoginPageProps) {
  ...
  return <CompanyLoginTemplate onSubmitLogin={onSubmitLogin} title="" />;
}

export default CompanyLoginPage;

CompanyLoginPage.LayoutProps = {
  darkBg: false,
