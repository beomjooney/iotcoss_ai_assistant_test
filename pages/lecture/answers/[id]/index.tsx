...
import { QuizAnswersDetailTemplate } from 'src/templates';
...
export function QuizAnswersDetailPage() {
  const router = useRouter();
  const id = router.query['id'].toString();

  return <QuizAnswersDetailTemplate id={id} />;
}

export default QuizAnswersDetailPage;

QuizAnswersDetailPage.LayoutProps = {
  darkBg: false,
