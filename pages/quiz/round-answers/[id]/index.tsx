...
import { QuizAnswersRoundDetailTemplate } from 'src/templates';
...
export function QuizAnswersRoundDetailPage() {
  const router = useRouter();
  const id = router.query['id'].toString();

  return <QuizAnswersRoundDetailTemplate id={id} />;
}

export default QuizAnswersRoundDetailPage;

QuizAnswersRoundDetailPage.LayoutProps = {
  darkBg: false,
