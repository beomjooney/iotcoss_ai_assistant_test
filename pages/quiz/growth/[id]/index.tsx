...
import { QuizGrowthTemplate } from 'src/templates';
...
export function QuizGrowthPage() {
  const router = useRouter();
  const id = router.query['id'].toString();

  return <QuizGrowthTemplate id={id} />;
}

export default QuizGrowthPage;

QuizGrowthPage.LayoutProps = {
  darkBg: false,
