...
import { QuizCrewManageTemplate } from 'src/templates';
...
export function QuizCrewManagePage() {
  const router = useRouter();
  const id = router.query['id'].toString();

  return <QuizCrewManageTemplate id={id} />;
}

export default QuizCrewManagePage;

QuizCrewManagePage.LayoutProps = {
  darkBg: false,
