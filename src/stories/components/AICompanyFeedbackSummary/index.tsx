...
import { AICompanyFeedbackSummaryProps } from './types';
...
const AICompanyFeedbackSummary: React.FC<AICompanyFeedbackSummaryProps> = ({
  aiFeedbackDataTotal,
...
export default AICompanyFeedbackSummary;
