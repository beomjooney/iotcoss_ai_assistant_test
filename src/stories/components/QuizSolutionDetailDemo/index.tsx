...
export interface QuizSolutionDetailDemoProps {
  /** 배경 이미지 */
  imageName?: string;
  /** 제목 */
  title: string;
  ...
  className?: string;
  subTitle?: string;
  setQuizFlag: (flag: string) => void;
  // quizStatus: object;
}

const cx = classNames.bind(styles);
const QuizSolutionDetailDemo = ({
  ...
  useEffect(() => {
    if (isAnswerUpdate) {
      ...
      alert('최종답변이 완료 되었습니다. 다음버튼을 눌러주세요.');
      setQuizFlag('three');
    }
  }, [isAnswerUpdate]);
      ...
      <Desktop>
        <div className={cx(className, '')}>
          <div className="tw-mb-5">
            <div className="tw-h-[50px] tw-flex  tw-gap-4 tw-items-center tw-px-5 border border-danger tw-rounded-lg">
          ...
          <div className="tw-leading-normal tw-text-black tw-text-xl">
                ...
                <div>
                  ...
                  <TextareaAutosize
                    ...
                    style={{
                      ...
                      padding: 12,
                      resize: 'none',
                      maxHeight: '250px', // 최대 높이 설정 (스크롤을 표시하려면 설정)
                      overflow: 'auto',
                    }}
              ...
              {activeStep === 1 && (
                <div>
                  <div>
                    ...
                    <div className="border tw-rounded-lg tw-p-5 tw-my-5 tw-h-[300px] tw-flex tw-items-center tw-justify-center">
                      <button
                        type="button"
                        onClick={() => {
...
export default QuizSolutionDetailDemo;
