                      ...
                      <div className="tw-grid tw-grid-cols-10 tw-items-center tw-gap-3 tw-py-5">
                        ...
                        <div className="tw-col-span-1">
                          <button
                            ...
                            className="tw-mb-[1px] tw-py-[19px] tw-w-full tw-h-full tw-rounded tw-bg-white border border-secondary tw-border-[#e9ecf2] tw-text-sm tw-text-center tw-text-[#6a7380]"
                          >
                            댓글달기
                          </button>
                        </div>
