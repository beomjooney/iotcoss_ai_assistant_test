  ...
  return (
    <>
      <section
        ...
        style={{
          background: "url('assets/img/hero-bg-4.jpg')no-repeat center center / cover)",
        }}
      >
        <div className="container">
          <div className="row align-items-center justify-content-between">
            <div className="col-md-6 col-lg-6">
              <div className="hero-content-left position-relative mt-lg-0 mt-md-0 mt-5 text-white">
                ...
                <p className="lead">
                  Progressively monetize cost effective innovation vis-a-vis cross-unit infrastructures. Uniquely
                  e-enable front-end core competencies vis-a-vis premier.
                </p>

                <div className="video-promo-content mt-4 d-flex align-items-center">
                  <Link to="#" className="popup-youtube video-play-icon">
                    <span className="ti-control-play" onClick={() => setOpen(true)}></span>{' '}
                  </Link>
            ...
            <div className="col-md-5 col-lg-5">
              <div className="sign-up-form-wrap position-relative rounded p-5 gray-light-bg mt-5">
                ...
                <form action="#" method="post" id="getQuoteFrm" className="sign-up-form">
                  ...
                  <div className="form-group">
                    <input type="submit" name="submit" id="submit" className="btn solid-btn btn-block" value="Send" />
                  </div>
          ...
          <ModalVideo channel="youtube" isOpen={isOpen} videoId="9No-FiEInLA" onClose={() => setOpen(false)} />
        </div>
