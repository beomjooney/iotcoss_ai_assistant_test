...
import { SearchParamsProps } from 'pages/admin/system/manage-code/index';
...
export function CodeListTemplate({
  onSearch,
  onDelete,
  onSave,
  onAdd,
  ...
  const onShowPopup = (id: string) => {
    const result = codeList?.find(item => item?.id === id);
    let param = result;
  ...
  return (
    <div className="content">
      ...
      <div className="path">
        <span>Home</span> <span>코드그룹관리 목록</span>
      </div>
      ...
      <div className="data-type1" data-evt="main-table-on">
        <Table
          ...
          isEmpty={codeList?.length === 0 || false}
        />
        ...
        <div className="side-contents">
          <div className="layer-top">
            <div className="left" style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <div className="tit-type2">코드 추가</div>
            </div>
            <div className="right">
