...
export function AdminSeminarTemplate({
  seminarList,
  seminarData,
  ...
  onSave,
  onAdd,
}: SeminarTemplateProps) {
  const COLGROUP = ['10%', '8%', '10%', '6%', '6%', '7%', '6%', '6%', '5%', '8%', '8%', '8%', '8%'];
  const HEADS = [
    '세미나시작일시',
    '강사명',
    '세미나명',
  ...
  const FIELDS = [
    { name: '세미나 아이디', field: 'seminarId', type: 'text' },
    { name: '세미나 명(주제)', field: 'seminarTitle', type: 'text' },
    { name: '세미나 명(진행자 소개)', field: 'seminarSubTitle', type: 'text' },
    { name: '세미나 소개', field: 'seminarIntroduction', type: 'text' },
    { name: '설명', field: 'description', type: 'text' },
    { name: '세미나 상태', field: 'seminarStatus', type: 'choice', data: seminarStatus },
    { name: '세미나 유형', field: 'seminarType', type: 'choice', data: seminarTypes },
    { name: '개설회원 아이디', field: 'organizerMemberId', type: 'text' },
    { name: '강사 아이디', field: 'lecturerMemberId', type: 'text' },
    { name: '강사 명', field: 'lecturerName', type: 'text' },
    { name: '추천직군', field: 'recommendJobGroups', type: 'text' },
    // { name: '설명', field: 'recommendJobs', type: 'text' },
    { name: '추천레벨', field: 'recommendLevels', type: 'text' },
    { name: '키워드', field: 'keywords', type: 'text' },
  ];
...
export default AdminSeminarTemplate;
