                                        ...
                                        return (
                                          <div>
                                            <svg
                                              ...
                                              fill="none"
                                            >
                                              <rect width="72" height="24" rx="12" fill="#313B4B" fill-opacity="0.05" />
                                        ...
                                        return (
                                          <div>
                                            <svg
                                              ...
                                              fill="none"
                                            >
                                              <rect width="72" height="24" rx="12" fill="#06C090" fill-opacity="0.05" />
                                              <path
                                        ...
                                        return (
                                          <div>
                                            <svg
                                              ...
                                              fill="none"
                                            >
                                              <rect width="72" height="24" rx="12" fill="#FE2E36" fill-opacity="0.05" />
                                              <path
                                        ...
                                        return (
                                          <div>
                                            <svg
                                              ...
                                              fill="none"
                                            >
                                              <rect width="72" height="24" rx="12" fill="#2300FF" fill-opacity="0.05" />
                                              <path
