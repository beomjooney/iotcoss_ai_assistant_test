...
export function AdminDashboardTemplate() {
  ...
  const [chartOptions, setChartOptions] = useState({
    ...
    yaxis: [
      ...
      },
      {
        opposite: true,
        title: {
          text: 'Cumulative Data', // 오른쪽 Y축의 이름
        },
        labels: {
          formatter: value => `${value} units`,
        },
    ...
    colors: ['#FFC300', '#28A745', '#007BFF', '#FF5733'], // 노랑, 초록, 파랑, 주황
  });
  ...
  const [chartSeries, setChartSeries] = useState([
    ...
    {
      name: 'Cumulative Series C',
      data: [10, 20, 15, 30, 25, 40, 55],
      type: 'bar',
      yAxisIndex: 1, // 오른쪽 Y축에 연결
    },
    {
      name: 'Cumulative Series D',
      data: [15, 25, 20, 35, 30, 45, 65],
      type: 'bar',
      yAxisIndex: 1, // 오른쪽 Y축에 연결
    },
  ]);
                  ...
                  {isMemberListFetched && (
                    <div className="">
                      <div className="border tw-p-7 tw-rounded-lg">
                        <div className="tw-font-bold tw-text-xl tw-text-black tw-mt-5 tw-mb-10">사용자수 통계</div>
                        ...
                        <div>
                          <div className="tw-flex tw-gap-8">
                            <div className="border tw-w-60 tw-h-[120px] tw-relative tw-rounded-lg tw-bg-[#fdfdff] tw-border tw-border-[#e9ecf2]">
                              ...
                              <p className="tw-px-5   tw-text-[50px] tw-font-light  tw-text-[#1573ff]">13</p>
                            </div>
                            <div className="border tw-w-60 tw-h-[120px] tw-relative tw-rounded-lg tw-bg-[#fdfdff] tw-border tw-border-[#e9ecf2]">
                              <div className="tw-flex tw-p-5 tw-pb-0 tw-items-center tw-gap-1 ">
                                <p className=" tw-text-sm tw-font-medium tw-text-left tw-text-[#6a7380] tw-mr-2">
                      ...
                      <div className="tw-py-5 tw-px-7 border tw-rounded-lg tw-mt-10">
                        ...
                        <div className="tw-text-base tw-text-black tw-font-bold tw-my-5">인기 퀴즈</div>
                        <div className="tw-px-5 tw-flex tw-justify-between tw-self-stretch tw-flex-grow-0 tw-flex-shrink-0 tw-h-[59px] tw-relative tw-overflow-hidden tw-rounded tw-bg-[#fdfdff] border">
                          <div className="tw-flex tw-justify-start tw-items-center  tw-gap-2">
                            <p className="tw-flex-grow-0 tw-flex-shrink-0 tw-text-base tw-font-bold tw-text-left tw-text-[#2474ed]">
                              1.
                            </p>
                            <p className="tw-flex-grow-0 tw-flex-shrink-0 tw-text-base  tw-text-left tw-text-black tw-line-clamp-1">
                        ...
                        <div className="tw-text-base tw-text-black tw-font-bold tw-my-5 tw-mt-10">활성 퀴즈</div>
                        <div className="tw-p-5 tw-flex tw-justify-between tw-self-stretch tw-flex-grow-0 tw-flex-shrink-0 tw-relative tw-overflow-hidden tw-rounded tw-bg-[#fdfdff] border">
                          <div className="tw-flex tw-justify-start tw-items-center  tw-gap-2">
                      ...
                      <div className="tw-py-5 tw-px-7 border tw-rounded-lg tw-mt-10">
                        ...
                        <div className="tw-text-base tw-text-black tw-font-bold tw-my-5">클럽 답변</div>
                        <div className="tw-p-5 tw-flex tw-justify-between tw-self-stretch tw-flex-grow-0 tw-flex-shrink-0  tw-relative tw-overflow-hidden tw-rounded tw-bg-[#fdfdff] border">
                          <div className="tw-flex tw-justify-start tw-items-center  tw-gap-2">
                            <div className="tw-flex tw-flex-col tw-justify-start tw-items-start tw-gap-1">
                              <div className="tw-flex tw-flex-row tw-justify-start tw-items-center tw-gap-1">
                              ...
                              <div className="tw-pl-4 tw-flex-grow-0 tw-flex-shrink-0 tw-text-sm  tw-text-left tw-text-gray-400 tw-line-clamp-1">
                                <span className="tw-text-black">임효택 교수님</span> | 2023.00.00 ~ 2023.00.00 | 월, 목
                                | 퀴즈클럽 12주 | 학습 24주
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="tw-text-base tw-text-black tw-font-bold tw-my-5 tw-mt-10">클럽 리액션</div>
                        <div className="tw-p-5 tw-flex tw-justify-between tw-self-stretch tw-flex-grow-0 tw-flex-shrink-0 tw-relative tw-overflow-hidden tw-rounded tw-bg-[#fdfdff] border">
                          <div className="tw-flex tw-justify-start tw-items-center  tw-gap-2">
                            <div className="tw-flex tw-flex-col tw-justify-start tw-items-start tw-gap-1">
                              <div className="tw-flex tw-flex-row tw-justify-start tw-items-center tw-gap-1">
