        ...
        <div className="sidebar-left pr-4">
          ...
          <aside className="widget widget-recent-entries-custom">
            ...
            <ul>
              <li className="clearfix">
                <div className="wi">
                  <Link to="/blog-details">
                    <img src="assets/img/blog/1.jpg" alt="recent post" className="img-fluid rounded" />
                  </Link>
                </div>
                <div className="wb">
                  <Link to="/blog-details">Map where your photos were taken and discover local points.</Link>
              ...
              <li className="clearfix">
                <div className="wi">
                  <Link to="/blog-details">
                    <img src="assets/img/blog/2.jpg" alt="recent post" className="img-fluid rounded" />
                  </Link>
                </div>
                <div className="wb">
                  <Link to="/blog-details">Map where your photos were taken and discover local points.</Link>
              ...
              <li className="clearfix">
                <div className="wi">
                  <a href="#/">
                    <img src="assets/img/blog/3.jpg" alt="recent post" className="img-fluid rounded" />
                  </a>
                </div>
                <div className="wb">
                  <Link to="/blog-details">Map where your photos were taken and discover local points.</Link>
          ...
          <aside className="widget widget-categories">
            ...
            <form action="#//" method="post" className="d-none d-md-block d-lg-block">
              ...
              />
              <button type="submit" className="btn solid-btn btn-block btn-not-rounded mt-3">
                Subscribe
              </button>
            </form>
          </aside>
