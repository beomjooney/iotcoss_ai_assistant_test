        ...
        <div className="container">
            ...
            <div className="col-md-8">
              <div className="section-heading mb-5">
                ...
                <p>
                  ...
                  tactical methods of empowerment via resource sucking core.
                </p>
              </div>
            </div>
          </div>
          <div className="row">
            {blogData.map((data, index) => (
              <div className="col-md-4" key={`row-${index}`}>
                <div className="single-blog-card card border-0 shadow-sm">
                  <span className="category position-absolute badge badge-pill badge-primary">{data.category}</span>
                  <img src={data.thumbnail} className="card-img-top position-relative" alt="blog" />
