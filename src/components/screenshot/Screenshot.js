          ...
          <div className="row justify-content-center">
            <div className="col-md-8">
              <div className="section-heading text-center">
                {hasBg ? <span className="text-uppercase color-secondary sub-title">App Screenshots</span> : ''}
                <h2>App Screenshots Looks Awesome</h2>
                <p className="lead">
                  Credibly synthesize multimedia based networks vis-a-vis top-line growth strategies. Continually
