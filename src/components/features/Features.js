            ...
            <div className="row align-items-center justify-content-between">
                ...
                <div className="about-content-left section-heading">
                  ...
                  <div className="single-feature mb-4 mt-5">
                    <div className="icon-box-wrap d-flex align-items-center mb-2">
                      ...
                      <p className="mb-0">
                        Proactively syndicate open-source e-markets after low-risk high-yield synergy. Professionally
                  ...
                  <div className="single-feature mb-4">
                    <div className="icon-box-wrap mb-2">
                      ...
                      <p className="mb-0">
                        Intrinsicly aggregate cutting-edge internal or "organic" sources through pandemic manufactured
                        Synergistically.
                      </p>
                    </div>
                    <p></p>
                  ...
                  <div className="single-feature mb-4">
                    <div className="icon-box-wrap mb-2">
                      ...
                      <p className="mb-0">
                        Completely administrate empowered e-tailers after extensive experiences. Holisticly leverage
                        quality networks.
                      </p>
                    </div>
                    <p></p>
                  ...
                  <div className="single-feature mb-4">
                    <div className="icon-box-wrap mb-2">
                      ...
                      <p className="mb-0">
                        Intrinsicly incentivize functionalized metrics whereas go forward networks. Collaboratively
              ...
              <div className="col-md-5">
                <div className="about-content-right">
                  <img src="assets/img/image-11.png" alt="about us" className="img-fluid" />
                </div>
              </div>
            </div>
          </div>
