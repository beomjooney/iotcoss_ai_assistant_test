          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-md-4">
              <div className="download-img">
                <img src="assets/img/image-10.png" alt="download" className="img-fluid" />
              </div>
            </div>
            <div className="col-md-7">
              <div className="feature-contents section-heading">
                ...
                <p>
                  Objectively deliver professional value with diverse web-readiness. Collaboratively transition wireless
                  service without goal-oriented catalysts for change incubate unique benefits for extensible resources.
                </p>
                ...
                <div className="feature-content-wrap">
                  <ul className="nav nav-tabs feature-tab" data-tabs="tabs">
                    ...
                    <li className="nav-item">
                      <a className="nav-link h6" href="#tab6-3" data-toggle="tab">
                        <span className="ti-bar-chart"></span>
                        Marketing
                      </a>
                    </li>
                    <li className="nav-item">
                      <a className="nav-link h6" href="#tab6-4" data-toggle="tab">
                  ...
                  <div className="tab-content feature-tab-content">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="py-2">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <p className="mb-0">Create your own skin to match your brand</p>
                            </div>
                          </div>
                        </li>
                        <li className="py-2">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <p className="mb-0">Globally orchestrate tactical channels whereas bricks</p>
                            </div>
                          </div>
                        </li>
                        <li className="py-2">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <p className="mb-0">Use Gulp to prepare all assets for production</p>
                            </div>
                          </div>
                        </li>
                        <li className="py-2">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <p className="mb-0">Collaboratively predominate vertical manufactured</p>
                            </div>
                          </div>
                        </li>
                      </ul>
                    ...
                    <div className="tab-pane" id="tab6-2">
                      <div className="single-feature">
                        ...
                        <p>
                          ...
                          Continually pontificate stand-alone benefits whereas.
                        </p>
                      </div>
                      <div className="single-feature mb-4">
                        ...
                        <p>
                          Phosfluorescently empower compelling intellectual capital and revolutionary web services.
                          develop cross-media.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="tab-pane" id="tab6-4">
                      <p>
                        I have, to push possibilities, to show people, this is the level that things could be at. So
                        when you get something that has the name Kanye West on it, it’s supposed to be pushing the
                        furthest possibilities. I will be the leader of a company that ends up being worth billions of
