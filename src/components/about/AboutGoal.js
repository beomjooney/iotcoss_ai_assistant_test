          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-md-6">
              <div className="about-content-left section-heading">
                <span className="text-uppercase color-secondary sub-title">About Our Goal</span>
                ...
                <p>
                  ...
                  technology before team driven sources grow bleeding-edge leadership.{' '}
                </p>
                ...
                <div className="single-feature mb-4">
                  ...
                  <p>
                    Synergistically deliver next-generation relationships whereas bleeding-edge resources. Continually
                ...
                <div className="single-feature mb-4">
                  ...
                  <p>
                    Phosfluorescently matrix enterprise-wide metrics vis-a-vis extensive imperatives. Energistically
            ...
            <div className="col-md-6">
              <div className="about-content-right">
                <img src="assets/img/about-img.png" alt="about us" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
