    ...
    <>
      ...
      >
              ...
              <div className="card login-signup-card shadow-lg mb-0">
                <div className="card-body px-md-5 py-5">
                  ...
                  <form className="login-signup-form">
                    ...
                    <button className="btn btn-lg btn-block solid-btn border-radius mt-4 mb-3">Sign up</button>
                  </form>
                </div>
        ...
        <div className="bottom-img-absolute">
          <img src="assets/img/wave-shap.svg" alt="wave shape" className="img-fluid" />
        </div>
      </section>
    </>
  );
