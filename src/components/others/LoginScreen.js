          ...
          <div className="row align-items-center justify-content-between pt-5 pt-sm-5 pt-md-5 pt-lg-0">
            <div className="col-md-7 col-lg-6">
              <div className="hero-content-left text-white">
                ...
                <p className="lead">Keep your face always toward the sunshine - and shadows will fall behind you.</p>
              </div>
            </div>
                  ...
                  <form className="login-signup-form">
                    <div className="form-group">
                      ...
                      <div className="input-group input-group-merge">
                        ...
                        <input type="email" className="form-control" placeholder="name@yourdomain.com" />
                      </div>
                    </div>
                    ...
                    <button className="btn btn-lg btn-block solid-btn border-radius mt-4 mb-3">Sign in</button>
                  </form>
                </div>
