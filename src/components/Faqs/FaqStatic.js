          ...
          <div className="row">
            <div className="col-md-6">
              <div className="single-faq">
                ...
                <p>
                  Intrinsicly implement high standards in strategic theme areas via inexpensive solutions. Assertively
            ...
            <div className="col-md-6">
              <div className="single-faq">
                ...
                <p>
                  ...
                  resource sucking manufactured products without high-payoff paradigms. Objectively customize ubiquitous
            ...
            <div className="col-md-6">
              <div className="single-faq">
                ...
                <p>
                  ...
                  repurpose integrated customer service after magnetic e-services.{' '}
                </p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="single-faq">
                ...
                <p>
                  Enthusiastically pontificate resource-leveling supply chains whereas scalable markets. Authoritatively
            ...
            <div className="col-md-6">
              <div className="single-faq">
                ...
                <p>
                  Assertively target turnkey ideas for market-driven portals. Appropriately e-enable world-class
