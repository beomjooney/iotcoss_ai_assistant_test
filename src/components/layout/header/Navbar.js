        ...
        >
          <div className="container">
            <Link to="/" className="navbar-brand">
              {darkBg ? (
                <img src="assets/img/logo-white-1x.png" width="120" alt="logo" className="img-fluid" />
              ) : (
                <img src="assets/img/logo-color-1x.png" width="120" alt="logo" className="img-fluid" />
              )}
            </Link>
            <button
            ...
            <div className="collapse navbar-collapse main-menu" id="navbarSupportedContent">
              <ul className="navbar-nav ml-auto">
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu submenu" aria-labelledby="navbarDropdownHome">
                    ...
                    <Link to="/home-eight" className="dropdown-item">
                      Demo Template 8<span className="badge badge-warning">New</span>
                    </Link>
                  </div>
                </li>
                ...
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu submenu" aria-labelledby="navbarDropdownPage">
                    ...
                    <Link className="dropdown-item" to="/our-team">
                      Team Page
                      <span className="badge badge-danger badge-pill ml-2">New</span>
                    </Link>
                    <Link className="dropdown-item" to="/team-details">
                      Team Single
                      <span className="badge badge-danger badge-pill ml-2">New</span>
                    </Link>
                    <Link className="dropdown-item" to="/home-nine">
                      Flow page
                      <span className="badge badge-danger badge-pill ml-2">New</span>
                    </Link>
                  </div>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    Blog
                    <span className="custom-nav-badge badge badge-danger badge-pill">New</span>
                  </Link>
